...
class BaseSerializer(Field[_GT]):
...
class Serializer(BaseSerializer[_GT], Mapping[str, BoundField]):
    @property
...
class ListSerializer(BaseSerializer[_GT]):
    child = None
    many: bool = ...
    def validate(self, attrs):
        return attrs
...
class ModelSerializer(Serializer[_GT]):
...
class HyperlinkedModelSerializer(ModelSerializer[_GT]): ...
