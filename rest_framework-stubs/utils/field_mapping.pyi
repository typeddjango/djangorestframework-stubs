...
def get_detail_view_name(model: type[models.Model]) -> str: ...
...
def get_relation_kwargs(field_name: str, relation_info: RelationInfo) -> dict[str, Any]: ...
def get_nested_relation_kwargs(relation_info: RelationInfo) -> dict[str, Any]: ...
def get_url_kwargs(model_field: type[models.Model]) -> dict[str, Any]: ...
def get_unique_error_message(model_field: models.Field) -> str | None: ...
