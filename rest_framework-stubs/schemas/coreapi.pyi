...
class SchemaGenerator(BaseSchemaGenerator):
    ...
    def __init__(
        ...
        patterns: Sequence[_AnyURL] | None = None,
        urlconf: str | None = None,
        version: str | None = None,
    ) -> None: ...
    def get_links(self, request: Request | None = None) -> LinkNode | None: ...
    @override
    def get_schema(self, request: Request | None = None, public: bool = False) -> coreapi.Document | None: ...
    def get_keys(self, subpath: Any, method: Any, view: APIView) -> list[str]: ...
    def determine_path_prefix(self, paths: list[str]) -> str: ...

def field_to_schema(field: Field) -> coreschema.Schema: ...

class AutoSchema(ViewInspector):
    def __init__(self, manual_fields: list[coreapi.Field] | None = None) -> None: ...
...
class ManualSchema(ViewInspector):
    def __init__(self, fields: list[coreapi.Field], description: str = "", encoding: str | None = None) -> None: ...
    def get_link(self, path: str, method: str, base_url: str) -> coreapi.Link: ...
