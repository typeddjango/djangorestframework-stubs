...
class CharField(Field[str, str, str, _IN]):
    allow_blank: bool = ...
...
class UUIDField(Field[uuid.UUID, Union[uuid.UUID, str, int], str, _IN]):
...
class IntegerField(Field[int, Union[float, int, str], int, _IN]):
...
class FloatField(Field[float, Union[float, int, str], str, _IN]):
    MAX_STRING_LENGTH: int = ...
    re_decimal: Pattern = ...
    max_value: Optional[int] = ...
    min_value: Optional[int] = ...
...
class DecimalField(Field[Decimal, Union[int, float, str, Decimal], str, _IN]):
    MAX_STRING_LENGTH: int = ...
...
class DateTimeField(Field[datetime.datetime, Union[datetime.datetime, str], str, _IN]):
...
class DateField(Field[datetime.date, Union[datetime.date, str], str, _IN]):
    datetime_parser: Callable[[str, str], datetime.datetime] = ...
    format: Optional[str] = ...
    input_formats: Sequence[str] = ...
    def __init__(
...
class TimeField(Field[datetime.time, Union[datetime.time, str], str, _IN]):
    datetime_parser: Callable[[str, str], datetime.datetime] = ...
    format: Optional[str] = ...
    input_formats: Sequence[str] = ...
    def __init__(
...
class DurationField(Field[datetime.timedelta, Union[datetime.timedelta, str], str, _IN]):
...
class ChoiceField(Field[str, Union[str, int, Tuple[Union[str, int], Union[str, int, tuple]]], str, _IN]):
...
class MultipleChoiceField(ChoiceField, Field[str, Sequence[Union[str, int, Tuple[Union[str, int], Union[str, int]]]], Sequence[Union[str, Tuple[Union[str, int], Union[str, int]]]], _IN]):
    allow_empty: bool = ...
    def __init__(
        self,
        choices: Sequence[Any],
...
class FileField(Field[File, File, Union[str, None], _IN]):  # this field can return None without raising!
    max_length: int = ...
...
class ListField(Field[List[Any], List[Any], List[Any], _IN]):
    child: Field = ...
    allow_empty: bool = ...
    max_length: Optional[int] = ...
    min_length: Optional[int] = ...
...
class DictField(Field[Dict[Any, Any], Dict[Any, Any], Dict[Any, Any], _IN]):
    child: Field = ...
    allow_empty: bool = ...
    def __init__(
        self,
...
class JSONField(Field[Union[Dict[str, Any], List[Dict[str, Any]]], Union[Dict[str, Any], List[Dict[str, Any]]], str, _IN]):
    binary: bool = ...
