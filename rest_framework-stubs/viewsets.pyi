...
from rest_framework.decorators import _ACTION
from rest_framework.views import _VIEW
...
class ViewSetMixin:
    ...
    action: str
    @classmethod
    def as_view(cls, actions: Optional[Dict[str, Union[str, _ACTION]]] = ..., **initkwargs: Any) -> _VIEW: ...
