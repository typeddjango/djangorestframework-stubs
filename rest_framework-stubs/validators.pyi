...
def qs_filter(queryset: QuerySet[_T, _T], **kwargs: Any) -> QuerySet[_T, _T]: ...
...
class UniqueValidator(object):
    ...
    def filter_queryset(self, value: Any, queryset: QuerySet[_T, _T]) -> QuerySet[_T, _T]: ...
    def exclude_current_instance(self, queryset: QuerySet[_T, _T]) -> QuerySet[_T, _T]: ...
...
class UniqueTogetherValidator(object):
    ...
    def filter_queryset(self, attrs: MutableMapping[str, Any], queryset: QuerySet[_T, _T]) -> QuerySet[_T, _T]: ...
    def exclude_current_instance(
        self, attrs: MutableMapping[str, Any], queryset: QuerySet[_T, _T]
    ) -> QuerySet[_T, _T]: ...
