from typing import Any, Dict, List, Optional, Sequence, Type, TypeVar, Union, Protocol
...
def get_object_or_404(
    queryset: Union[Type[_MT], Manager[_MT], QuerySet[_MT]], *filter_args: Any, **filter_kwargs: Any
) -> _MT: ...

class UsesQuerySet(Protocol[_MT]):
    def get_queryset(self) -> QuerySet[_MT]: ...

class GenericAPIView(views.APIView, UsesQuerySet):
    ...
    def get_serializer(self, *args: Any, **kwargs: Any) -> BaseSerializer[Any, Any, Any, _MT]: ...
    def get_serializer_class(self) -> BaseSerializer[Any, Any, Any, _MT]: ...
    def get_serializer_context(self) -> Dict[str, Any]: ...
    def filter_queryset(self, queryset: QuerySet[_MT]) -> QuerySet[_MT]: ...
    @property
    def paginator(self) -> Optional[BasePagination]: ...
    def paginate_queryset(self, queryset: QuerySet[_MT]) -> Optional[Sequence[Any]]: ...
