...
class Serializer(BaseSerializer, metaclass=SerializerMetaclass):
    ...
    def update(self, instance: Mapping[str, Any], validated_data: OrderedDict) -> Dict[str, Any]: ...
    def create(self, validated_data: OrderedDict) -> Dict[str, Any]: ...
...
class ListSerializer(BaseSerializer):
    ...
    def to_internal_value(self, data: List[Mapping[str, Any]]) -> List[Dict[str, Any]]: ...
    def to_representation(self, instance: List[Mapping[str, Any]]) -> List[Dict[str, Any]]: ...
    def update(self, instance: List[Mapping[str, Any]], validated_data: OrderedDict) -> List[Any]: ...
    def create(self, validated_data: OrderedDict) -> List[Any]: ...
