from typing import Any, Callable, Dict, List, NoReturn, Optional, Sequence, Tuple, Type, Mapping
...
class APIView(View):
    ...
    @classmethod
    def as_view(cls, **initkwargs: Any) -> _View: ...
