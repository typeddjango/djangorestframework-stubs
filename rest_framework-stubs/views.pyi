...
class APIView(View):
    ...
    @classmethod
    def as_view(cls, **initkwargs: Any) -> AsViewCallable: ...
    @property
    def allowed_methods(self) -> List[str]: ...
    @property
    def default_response_headers(self) -> Dict[str, str]: ...
    def http_method_not_allowed(self, request: Request, *args: Any, **kwargs: Any) -> None: ...
    def permission_denied(self, request: Request, message: Optional[str] = ...) -> None: ...
